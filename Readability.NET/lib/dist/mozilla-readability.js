...
/* harmony import */ var linkedom_worker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! linkedom/worker */ "./node_modules/linkedom/worker.js");



function parse(html) {
    const document = (0,linkedom_worker__WEBPACK_IMPORTED_MODULE_1__.parseHTML)(html);
    document.window.document.firstChild.__JSDOMParser__ = new linkedom_worker__WEBPACK_IMPORTED_MODULE_1__.DOMParser(); // Readability needs this
    const reader = new _mozilla_readability__WEBPACK_IMPORTED_MODULE_0__.Readability(document.window.document);
    return reader.parse();
}
...
/***/ "./node_modules/javy/dist/fs/index.cjs":
/*!*********************************************!*\
  !*** ./node_modules/javy/dist/fs/index.cjs ***!
  \*********************************************/
...
"use strict";
Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const o=__webpack_require__(/*! ../index.cjs */ "./node_modules/javy/dist/index.cjs");function l(i){let r=new Uint8Array(1024),e=0;for(;;){const t=Javy.IO.readSync(i,r.subarray(e));if(t<0)throw Error("Error while reading from file descriptor");if(t===0)return r.subarray(0,e+t);if(e+=t,e===r.length){const n=new Uint8Array(r.length*2);n.set(r),r=n}}}function a(i,r){for(;r.length>0;){const e=Javy.IO.writeSync(i,r);if(e<0)throw Error("Error while writing to file descriptor");if(e===0)throw Error("Could not write all contents in buffer to file descriptor");r=r.subarray(e)}}exports.STDIO=o.STDIO;exports.readFileSync=l;exports.writeFileSync=a;


/***/ }),

/***/ "./node_modules/javy/dist/index.cjs":
/*!******************************************!*\
  !*** ./node_modules/javy/dist/index.cjs ***!
  \******************************************/
...
"use strict";
Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});var r=(t=>(t[t.Stdin=0]="Stdin",t[t.Stdout=1]="Stdout",t[t.Stderr=2]="Stderr",t))(r||{});exports.STDIO=r;
...
/* harmony export */   Event: () => (/* binding */ GlobalEvent),
/* harmony export */   EventTarget: () => (/* binding */ DOMEventTarget),
/* harmony export */   Facades: () => (/* binding */ Facades),
/* harmony export */   HTMLAnchorElement: () => (/* binding */ HTMLAnchorElement),
/* harmony export */   HTMLAreaElement: () => (/* binding */ HTMLAreaElement),
/* harmony export */   HTMLAudioElement: () => (/* binding */ HTMLAudioElement),
/* harmony export */   HTMLBRElement: () => (/* binding */ HTMLBRElement),
/* harmony export */   HTMLBaseElement: () => (/* binding */ HTMLBaseElement),
/* harmony export */   HTMLBodyElement: () => (/* binding */ HTMLBodyElement),
/* harmony export */   HTMLButtonElement: () => (/* binding */ HTMLButtonElement),
/* harmony export */   HTMLCanvasElement: () => (/* binding */ HTMLCanvasElement),
/* harmony export */   HTMLClasses: () => (/* binding */ HTMLClasses),
/* harmony export */   HTMLDListElement: () => (/* binding */ HTMLDListElement),
/* harmony export */   HTMLDataElement: () => (/* binding */ HTMLDataElement),
/* harmony export */   HTMLDataListElement: () => (/* binding */ HTMLDataListElement),
/* harmony export */   HTMLDetailsElement: () => (/* binding */ HTMLDetailsElement),
/* harmony export */   HTMLDirectoryElement: () => (/* binding */ HTMLDirectoryElement),
/* harmony export */   HTMLDivElement: () => (/* binding */ HTMLDivElement),
/* harmony export */   HTMLElement: () => (/* binding */ HTMLElement),
/* harmony export */   HTMLEmbedElement: () => (/* binding */ HTMLEmbedElement),
/* harmony export */   HTMLFieldSetElement: () => (/* binding */ HTMLFieldSetElement),
/* harmony export */   HTMLFontElement: () => (/* binding */ HTMLFontElement),
/* harmony export */   HTMLFormElement: () => (/* binding */ HTMLFormElement),
/* harmony export */   HTMLFrameElement: () => (/* binding */ HTMLFrameElement),
/* harmony export */   HTMLFrameSetElement: () => (/* binding */ HTMLFrameSetElement),
/* harmony export */   HTMLHRElement: () => (/* binding */ HTMLHRElement),
/* harmony export */   HTMLHeadElement: () => (/* binding */ HTMLHeadElement),
/* harmony export */   HTMLHeadingElement: () => (/* binding */ HTMLHeadingElement),
/* harmony export */   HTMLHtmlElement: () => (/* binding */ HTMLHtmlElement),
/* harmony export */   HTMLIFrameElement: () => (/* binding */ HTMLIFrameElement),
/* harmony export */   HTMLImageElement: () => (/* binding */ HTMLImageElement),
/* harmony export */   HTMLInputElement: () => (/* binding */ HTMLInputElement),
/* harmony export */   HTMLLIElement: () => (/* binding */ HTMLLIElement),
/* harmony export */   HTMLLabelElement: () => (/* binding */ HTMLLabelElement),
/* harmony export */   HTMLLegendElement: () => (/* binding */ HTMLLegendElement),
/* harmony export */   HTMLLinkElement: () => (/* binding */ HTMLLinkElement),
/* harmony export */   HTMLMapElement: () => (/* binding */ HTMLMapElement),
/* harmony export */   HTMLMarqueeElement: () => (/* binding */ HTMLMarqueeElement),
/* harmony export */   HTMLMediaElement: () => (/* binding */ HTMLMediaElement),
/* harmony export */   HTMLMenuElement: () => (/* binding */ HTMLMenuElement),
/* harmony export */   HTMLMetaElement: () => (/* binding */ HTMLMetaElement),
/* harmony export */   HTMLMeterElement: () => (/* binding */ HTMLMeterElement),
/* harmony export */   HTMLModElement: () => (/* binding */ HTMLModElement),
/* harmony export */   HTMLOListElement: () => (/* binding */ HTMLOListElement),
/* harmony export */   HTMLObjectElement: () => (/* binding */ HTMLObjectElement),
/* harmony export */   HTMLOptGroupElement: () => (/* binding */ HTMLOptGroupElement),
/* harmony export */   HTMLOptionElement: () => (/* binding */ HTMLOptionElement),
/* harmony export */   HTMLOutputElement: () => (/* binding */ HTMLOutputElement),
/* harmony export */   HTMLParagraphElement: () => (/* binding */ HTMLParagraphElement),
/* harmony export */   HTMLParamElement: () => (/* binding */ HTMLParamElement),
/* harmony export */   HTMLPictureElement: () => (/* binding */ HTMLPictureElement),
/* harmony export */   HTMLPreElement: () => (/* binding */ HTMLPreElement),
/* harmony export */   HTMLProgressElement: () => (/* binding */ HTMLProgressElement),
/* harmony export */   HTMLQuoteElement: () => (/* binding */ HTMLQuoteElement),
/* harmony export */   HTMLScriptElement: () => (/* binding */ HTMLScriptElement),
/* harmony export */   HTMLSelectElement: () => (/* binding */ HTMLSelectElement),
/* harmony export */   HTMLSlotElement: () => (/* binding */ HTMLSlotElement),
/* harmony export */   HTMLSourceElement: () => (/* binding */ HTMLSourceElement),
/* harmony export */   HTMLSpanElement: () => (/* binding */ HTMLSpanElement),
/* harmony export */   HTMLStyleElement: () => (/* binding */ HTMLStyleElement),
/* harmony export */   HTMLTableCaptionElement: () => (/* binding */ HTMLTableCaptionElement),
/* harmony export */   HTMLTableCellElement: () => (/* binding */ HTMLTableCellElement),
/* harmony export */   HTMLTableElement: () => (/* binding */ HTMLTableElement),
/* harmony export */   HTMLTableRowElement: () => (/* binding */ HTMLTableRowElement),
/* harmony export */   HTMLTemplateElement: () => (/* binding */ HTMLTemplateElement),
/* harmony export */   HTMLTextAreaElement: () => (/* binding */ HTMLTextAreaElement),
/* harmony export */   HTMLTimeElement: () => (/* binding */ HTMLTimeElement),
/* harmony export */   HTMLTitleElement: () => (/* binding */ HTMLTitleElement),
/* harmony export */   HTMLTrackElement: () => (/* binding */ HTMLTrackElement),
/* harmony export */   HTMLUListElement: () => (/* binding */ HTMLUListElement),
/* harmony export */   HTMLUnknownElement: () => (/* binding */ HTMLUnknownElement),
/* harmony export */   HTMLVideoElement: () => (/* binding */ HTMLVideoElement),
...
/* harmony export */   illegalConstructor: () => (/* binding */ illegalConstructor),
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _readability_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./readability-service */ "./readability-service.ts");

const { readFileSync, writeFileSync, STDIO } = __webpack_require__(/*! javy/fs */ "./node_modules/javy/dist/fs/index.cjs");
...
const readabilityResult = (0,_readability_service__WEBPACK_IMPORTED_MODULE_0__["default"])(inputHtml);
